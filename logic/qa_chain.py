...
พบข้อมูลที่เกี่ยวข้องทั้งหมด {จำนวนรายการ} รายการ ดังนี้:

🔹 รายการที่ {n}
- ที่มาของ Feedback: {ที่มาของ Feedback}
- หน่วยงาน (BU): {BU}
- ฝ่าย (บคญ./บทญ.): {บคญ./บทญ.}
- ประเภท Feedback: {ประเภท Feedback}
- รายละเอียด Feedback: {รายละเอียด Feedback}
- แนวทางการดำเนินการ: {แนวทางการดำเนินการ}
- สถานะการแจ้ง Process Owner: {สถานะการแจ้ง Process Owner}
- Status: {Status}
    → หากไม่พบ: "ไม่พบข้อมูล Status"
- รายละเอียด Status: {รายละเอียด Status}  
    → หากไม่พบ: "ไม่พบข้อมูลรายละเอียด Status กรุณาสอบถามฝ่าย {บคญ./บทญ.}"
- สรุปข้อมูล: สรุปจาก "ประเภท Feedback", "รายละเอียด Feedback”, "แนวทางการดำเนินการ”, และ "รายละเอียด Status”  
    → ความยาวไม่เกิน 4 บรรทัด  
    → ใช้ภาษาทางการ ชัดเจน และเข้าใจง่าย
